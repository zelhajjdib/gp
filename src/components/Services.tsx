    ...
    <section id="services" className="py-28 bg-[#080808]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16">
          ...
          <p className="text-[#3a3a3a] text-xs tracking-widest uppercase max-w-xs leading-loose lg:text-right lg:mb-1">
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3 mb-3">
                ...
                <span className="shrink-0 text-[9px] text-[#444] uppercase tracking-widest border border-[#1a1a1a] px-2 py-1 mt-0.5">
                  {service.duration}
                </span>
              </div>

              {/* Description */}
              <p className="text-[#4a4a4a] text-sm leading-relaxed mb-6 flex-grow">
                {service.description}
              </p>
              ...
              <ul className="space-y-2 mb-8">
                {service.includes.map((item) => (
                  <li key={item} className="flex items-center gap-2.5 text-[11px] text-[#555] tracking-wide">
                ...
                <a
                  ...
                  className={`text-[10px] font-bold uppercase tracking-[0.18em] px-4 py-2.5 transition-all duration-300 ${
                    service.featured
                      ...
                      : "border border-[#1c1c1c] hover:border-[#3D52D5]/50 text-[#555] hover:text-white"
                  }`}
                >
                  Réserver
                </a>
